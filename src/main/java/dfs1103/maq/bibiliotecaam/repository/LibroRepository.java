...
public interface LibroRepository extends JpaRepository<Libro, Long> {
    ...
    @Query("SELECT l FROM Libro l WHERE UPPER(l.titulo) LIKE UPPER(:titulo)") //----> Podriamos mas adelante agregar Concats
    ...
    List<Libro> findByPrecio(@Param("precio") Integer precio);
